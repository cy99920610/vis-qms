...
class Command(BaseCommand):
    help = "Create the VIS-QMS groups (management, employee, auditor) and the superuser from env vars."
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("Groups ready: management (admin doc rights), employee, auditor")
